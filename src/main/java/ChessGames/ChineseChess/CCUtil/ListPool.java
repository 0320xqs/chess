...
public class ListPool {
     ...
     */
    private final LinkedList<MyList<Point>> placeList17 = new LinkedList<>();
    /**
    ...
    @Getter
    private static final MyList<Point> emptyList = newList(0);
    ...
    public MyList<Point> getAPlaceList(int capacity) {
        final MyList<Point> pop = placeList17.poll();
        if (pop != null) {
            DebugInfo.incrementPollListCount();
            return pop;
        } else {
    ...
    public void addListToPool(MyList<Point> list) {
