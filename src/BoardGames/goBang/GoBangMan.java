...
public class GoBangMan extends Player implements GoBangConfig {
    ...
    public void play(GoBangChessPieces pieces, GoBangRules gameStatus) {
        ...
        chessType = gameStatus.currentPlayer ? CHESSTYPE1 : CHESSTYPE2;//判断是什么颜色的棋子
        ...
        chessArray[gameStatus.chessCount++] = pieces;//将棋子对象添加到棋子数组中
        //判赢
        if (gameStatus.win(x_index, y_index, gameStatus.currentPlayer)) {//判断是否胜利
